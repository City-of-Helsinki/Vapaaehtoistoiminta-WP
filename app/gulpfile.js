...
const paths = {
    ...
    php: ['src/wp-content/themes/' + process.env.WP_THEME_NAME + '/**/*.php', 'src/wp-content/plugins/linkedevents-wp-plugin/**/*.php', 'src/wp-config.php', 'src/wp-content/plugins/woocommerce/**/*.php', 'src/.htaccess']
};
